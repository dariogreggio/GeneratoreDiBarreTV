/********************************************************************
 FileName:     	HardwareProfile - PIC24EP256GP202 PIM.h
 Dependencies:  See INCLUDES section
 Processor:     PIC24EP256GP202
 Hardware:      PIC24EP256GP202 PIM
 Compiler:      Microchip C30/XC16
...
********************************************************************
 ...
 Change History:
  ...
  2.3   09/15/2008   Broke out each hardware platform into its own
				...
				13/11/2023		sempre morte agli umani ;) GD/C su demoboard filata :)
********************************************************************/
...
//    #define PROGRAMMABLE_WITH_USB_HID_BOOTLOADER	
    ...
    #if defined (__dsPIC33EP512MU810__) || defined (__dsPIC33EP256MU806__) || defined(__PIC24EP256GP202__) || defined(__PIC24EP512GP202__)
...
#define m_VideoPin LATBbits.LATB8  // per poter usare SDO... e anche PWM in caso
// alt-video ev. = RB9/PWM OC1
#define m_ChromaPin LATBbits.LATB11		//RP43 PWM OC4
